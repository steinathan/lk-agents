...
class InterceptHandler(logging.Handler):
    ...
    def emit(self, record: logging.LogRecord) -> None:  # pragma: no cover
        ...
        if frame.f_code:
            while (
                frame.f_code.co_filename == logging.__file__  # type: ignore
                or frame.f_code.co_filename == __file__  # type: ignore
                or "sentry_sdk/integrations" in frame.f_code.co_filename  # type: ignore
            ):
